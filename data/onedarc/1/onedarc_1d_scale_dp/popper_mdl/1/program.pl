...
% learning time: 20.687766707999998
% program size: 2
...
Solve_Encoding:
	Called: 1 times 	 Total: 10.18 	 Mean: 10.180 	 Max: 10.180 	 Percentage: 33%
Bkcons:
	Called: 1 times 	 Total: 9.59 	 Mean: 9.585 	 Max: 9.585 	 Percentage: 31%
Init:
