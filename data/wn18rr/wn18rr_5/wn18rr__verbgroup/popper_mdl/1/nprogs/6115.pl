...
verbgroup(V0,V1):- hypernym(V0,V3),derivationallyrelatedform(V1,V4),alsosee(V3,V2).
verbgroup(V0,V1):- hypernym(V0,V3),hypernym(V3,V2),hypernym(V1,V2).
...
verbgroup(V0,V1):- hypernym(V0,V3),hypernym(V1,V2),hypernym(V2,V3).
verbgroup(V0,V1):- hypernym(V0,V3),hypernym(V1,V2),alsosee(V4,V2).
verbgroup(V0,V1):- derivationallyrelatedform(V2,V0),hypernym(V3,V1),alsosee(V4,V3).
verbgroup(V0,V1):- hypernym(V1,V4),derivationallyrelatedform(V2,V0),alsosee(V4,V3).
...
verbgroup(V0,V1):- hypernym(V1,V4),hypernym(V0,V3),derivationallyrelatedform(V4,V2),derivationallyrelatedform(V2,V3).
verbgroup(V0,V1):- derivationallyrelatedform(V1,V4),derivationallyrelatedform(V0,V2),hypernym(V2,V3),derivationallyrelatedform(V3,V0).
